...
namespace LoBridge
{
    ...
    /// Form1 的摘要说明。
    /// </summary>
    public class WPreviewCamera : System.Windows.Forms.Form
    {
        string dvip;
        string uname;
        string pass;
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(WPreviewCamera));
        ...
        public void CaptureW(string type, string id, string shot)
        {
            ...
            if (type == "INW")
            {
                try
                {
                    bool exists = System.IO.Directory.Exists(@"D:\WCam\Incoming\");

                    if (!exists)
                        System.IO.Directory.CreateDirectory(@"D:\WCam\Incoming\");
            ...
            else if (type == "OUTW")
            {
                try
                {
                    bool exists = System.IO.Directory.Exists(@"D:\WCam\OutGoing\");

                    if (!exists)
                        System.IO.Directory.CreateDirectory(@"D:\WCam\OutGoing\");
