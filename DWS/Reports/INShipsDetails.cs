...
namespace LoBridge.Reports {
    ...
    public class INShipsDetails : ReportClass {
        
        public INShipsDetails() {
        }
        
        public override string ResourceName {
            get {
                return "INShipsDetails.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "LoBridge.Reports.INShipsDetails.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedINShipsDetails : Component, ICachedReport {
        
        public CachedINShipsDetails() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            INShipsDetails rpt = new INShipsDetails();
            rpt.Site = this.Site;
            return rpt;
        }
